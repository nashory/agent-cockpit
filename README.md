...
Claude Code, Codex, Gemini, OpenCode, Amp, Copilot, Kimi, Qwen, and Codebuff burn tokens all day. `agent-cockpit` reads their
...
- **🛩️ One cockpit for every agent.** Claude Code, Codex, Gemini, OpenCode, Amp, Copilot, Kimi, Qwen, and Codebuff in a single
...
- 🤖 **Unified view:** Claude Code, Codex, Gemini, OpenCode, Amp, Copilot, Kimi, Qwen, and Codebuff usage in one normalized cockpit.
...
internal/source/        Claude / Codex / Gemini / OpenCode / Amp / Copilot / Kimi / Qwen / Codebuff log adapters
