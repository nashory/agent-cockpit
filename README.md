...
Claude Code, Codex, Gemini, and OpenCode burn tokens all day. `agent-cockpit` reads their
...
- **🛩️ One cockpit for every agent.** Claude Code, Codex, Gemini, and OpenCode in a single
...
- 🤖 **Unified view:** Claude Code, Codex, Gemini, and OpenCode usage in one normalized cockpit.
...
internal/source/        Claude / Codex / Gemini / OpenCode log adapters
